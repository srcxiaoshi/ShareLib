...
# Cleaning the sharelib下的framework.
if [ -d "${SF_DEST_DIR}/../Framework/${INSTALL_DIR}" ]
then
rm -rf "${SF_DEST_DIR}/../Framework/${INSTALL_DIR}"
fi

cp -a "${INSTALL_DIR}" "${SF_DEST_DIR}/../Framework/"

# Cleaning the uikit下的framework.
if [ -d "${SF_DEST_DIR}/../SRCUIKit/SRCUIKit/Framework/${INSTALL_DIR}" ]
then
rm -rf "${SF_DEST_DIR}/../SRCUIKit/SRCUIKit/Framework/${INSTALL_DIR}"
fi

cp -a "${INSTALL_DIR}" "${SF_DEST_DIR}/../SRCUIKit/SRCUIKit/Framework/"
#open "${INSTALL_DIR}"
